...
$DB->unbuffered_query("ALTER TABLE `{$db_prefix}articles` ADD `readpassword` VARCHAR( 20 ) NOT NULL AFTER `stick` ;");
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>SABLOG-X v1.2 | Powered by 4ngel</title>
...
<div class="install_main">
  ...
  <div id="install_innertext">
    ...
    <p class="p2">当看到此信息时您的版本已经成功升级为 <u>SaBlog-X v 1.2</u>.</p>
    <p class="p2">请检查 <?php echo $db_prefix;?>articles 表中的是否添加了readpassword字段,类型是否为 <u>varchar</u>, 如果不是请手动升级.</p>
  </div>
</div>
